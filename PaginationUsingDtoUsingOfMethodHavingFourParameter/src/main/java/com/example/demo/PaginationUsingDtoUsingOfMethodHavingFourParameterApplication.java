...
public class PaginationUsingDtoUsingOfMethodHavingFourParameterApplication implements CommandLineRunner{

	public static void main(String[] args) {
		SpringApplication.run(PaginationUsingDtoUsingOfMethodHavingFourParameterApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		mobiles.add(Mobile.builder().mobileModel("OPPO A74").hardDisk(128).price(15990).ram(6).build());
		mobiles.add(Mobile.builder().mobileModel("OPPO A31").hardDisk(128).price(12490).ram(6).build());
